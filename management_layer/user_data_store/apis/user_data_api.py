...
class UserDataApi(object):
    ...
    def userdata_create(self, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.userdata_create(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.userdata_create_with_http_info(**kwargs)
        else:
            (data) = self.userdata_create_with_http_info(**kwargs)
            return data

    def userdata_create_with_http_info(self, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.userdata_create_with_http_info(callback=callback_function)
        ...
        return self.api_client.call_api('/userdata/', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def userdata_delete(self, user_id, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.userdata_delete(user_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.userdata_delete_with_http_info(user_id, **kwargs)
        else:
            (data) = self.userdata_delete_with_http_info(user_id, **kwargs)
            return data

    def userdata_delete_with_http_info(self, user_id, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.userdata_delete_with_http_info(user_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method userdata_delete" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'user_id' is set
        if ('user_id' not in params) or (params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `userdata_delete`")
        ...
        return self.api_client.call_api('/userdata/{user_id}/', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def userdata_list(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.userdata_list(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.userdata_list_with_http_info(**kwargs)
        else:
            (data) = self.userdata_list_with_http_info(**kwargs)
            return data

    def userdata_list_with_http_info(self, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.userdata_list_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method userdata_list" % key
                )
            params[key] = val
        del params['kwargs']

        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `userdata_list`, must be a value greater than or equal to `0`")
        if 'limit' in params and params['limit'] > 100:
            raise ValueError("Invalid value for parameter `limit` when calling `userdata_list`, must be a value less than or equal to `100`")
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `userdata_list`, must be a value greater than or equal to `1`")
        ...
        return self.api_client.call_api('/userdata/', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def userdata_read(self, user_id, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.userdata_read(user_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.userdata_read_with_http_info(user_id, **kwargs)
        else:
            (data) = self.userdata_read_with_http_info(user_id, **kwargs)
            return data

    def userdata_read_with_http_info(self, user_id, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.userdata_read_with_http_info(user_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method userdata_read" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'user_id' is set
        if ('user_id' not in params) or (params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `userdata_read`")
        ...
        return self.api_client.call_api('/userdata/{user_id}/', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def userdata_update(self, user_id, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.userdata_update(user_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.userdata_update_with_http_info(user_id, **kwargs)
        else:
            (data) = self.userdata_update_with_http_info(user_id, **kwargs)
            return data

    def userdata_update_with_http_info(self, user_id, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.userdata_update_with_http_info(user_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method userdata_update" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'user_id' is set
        if ('user_id' not in params) or (params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `userdata_update`")
        ...
        return self.api_client.call_api('/userdata/{user_id}/', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
