...
def add_routes(app, with_ui=False):
    ...
    app.router.add_view(r"/organisational_units/{organisational_unit_id}", views.OrganisationalUnitsOrganisationalUnitId)
    app.router.add_view(r"/organisational_units", views.OrganisationalUnits)
