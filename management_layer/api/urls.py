...
def add_routes(app, with_ui=False):
    ...
    app.router.add_view(r"/deletedusersite/{user_id}/{site_id}", views.DeletedusersiteUserIdSiteId)
    app.router.add_view(r"/deletedusersite", views.Deletedusersite)
    app.router.add_view(r"/deleteduser/{user_id}", views.DeleteduserUserId)
    app.router.add_view(r"/deleteduser", views.Deleteduser)
