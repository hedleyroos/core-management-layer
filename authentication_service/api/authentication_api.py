...
class AuthenticationApi(object):
    ...
    def request_user_deletion(self, request_user_deletion, **kwargs):  # noqa: E501
        """request_user_deletion  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.request_user_deletion(request_user_deletion, async=True)
        >>> result = thread.get()

        :param async bool
        :param RequestUserDeletion request_user_deletion: (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.request_user_deletion_with_http_info(request_user_deletion, **kwargs)  # noqa: E501
        else:
            (data) = self.request_user_deletion_with_http_info(request_user_deletion, **kwargs)  # noqa: E501
            return data

    def request_user_deletion_with_http_info(self, request_user_deletion, **kwargs):  # noqa: E501
        """request_user_deletion  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.request_user_deletion_with_http_info(request_user_deletion, async=True)
        >>> result = thread.get()
        ...
        all_params = ['request_user_deletion']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method request_user_deletion" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'request_user_deletion' is set
        if ('request_user_deletion' not in params or
                params['request_user_deletion'] is None):
            raise ValueError("Missing the required parameter `request_user_deletion` when calling `request_user_deletion`")  # noqa: E501
        ...
        body_params = None
        if 'request_user_deletion' in params:
            body_params = params['request_user_deletion']
        # HTTP header `Content-Type`
        header_params['Content-Type'] = self.api_client.select_header_content_type(  # noqa: E501
            ['application/json'])  # noqa: E501
