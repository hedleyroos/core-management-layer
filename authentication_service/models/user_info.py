...
class UserInfo(object):
    ...
    def __init__(self, sub=None, name=None, given_name=None, family_name=None, email=None, email_verified=None, phone_number=None, phone_number_verified=None, address=None):
        """
