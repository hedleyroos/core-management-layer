...
class UserInfo(Model):
    ...
    def __init__(self, sub: str=None, name: str=None, given_name: str=None, family_name: str=None, email: str=None, email_verified: bool=None, phone_number: str=None, phone_number_verified: bool=None, address: Address=None):  # noqa: E501
