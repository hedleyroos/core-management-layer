...
class Role(Model):
    ...
    """
    def __init__(self, id: int=None, label: RoleLabel=None, is_admin_role: bool=None, description: str=None, created_at: datetime=None, updated_at: datetime=None):
        """
    ...
    def is_admin_role(self, is_admin_role: bool):
        ...
        if is_admin_role is None:
            raise ValueError("Invalid value for `is_admin_role`, must not be `None`")
