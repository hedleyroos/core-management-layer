...
class UserUpdate(Model):
    ...
    def __init__(self, first_name: str=None, last_name: str=None, email: str=None, is_active: bool=None, email_verified: bool=None, msisdn_verified: bool=None, msisdn: str=None, gender: str=None, birth_date: date=None, avatar: str=None, country_code: str=None):  # noqa: E501
    ...
    def from_dict(cls, dikt) -> 'UserUpdate':
        ...
        :param dikt: A dict.
        :type: dict
        :return: The user_update of this UserUpdate.  # noqa: E501
        :rtype: UserUpdate
        """
