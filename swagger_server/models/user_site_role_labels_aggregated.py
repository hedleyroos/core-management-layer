...
class UserSiteRoleLabelsAggregated(Model):
    ...
    """
    def __init__(self, user_id: str=None, site_id: int=None, roles: List[RoleLabel]=None):
        """
    ...
    def from_dict(cls, dikt) -> 'UserSiteRoleLabelsAggregated':
        ...
        :param dikt: A dict.
        :type: dict
        :return: The user_site_role_labels_aggregated of this UserSiteRoleLabelsAggregated.
