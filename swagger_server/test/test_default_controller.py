...
class TestDefaultController(BaseTestCase):
    ...
    def test_sites_site_id_activate_get(self):
        ...
        """
        response = self.client.open('/api/v1/sites/{site_id}/activate/'.format(site_id=56),
                                    method='GET')
    ...
    def test_sites_site_id_deactivate_get(self):
        ...
        """
        response = self.client.open('/api/v1/sites/{site_id}/deactivate/'.format(site_id=56),
                                    method='GET')
        self.assert200(response, "Response body is : " + response.data.decode('utf-8'))
    ...
    def test_users_user_id_activate_get(self):
        ...
        """
        response = self.client.open('/api/v1/users/{user_id}/activate/'.format(user_id='user_id_example'),
                                    method='GET')
        self.assert200(response, "Response body is : " + response.data.decode('utf-8'))
    ...
    def test_users_user_id_deactivate_get(self):
        ...
        """
        response = self.client.open('/api/v1/users/{user_id}/deactivate/'.format(user_id='user_id_example'),
                                    method='GET')
        self.assert200(response, "Response body is : " + response.data.decode('utf-8'))
