...
class TestOidcProviderController(BaseTestCase):
    ...
    def test_client_list(self):
        ...
        query_string = [('offset', 1),
                        ('limit', 100),
                        ('client_ids', 56)]
        response = self.client.open('/api/v1/clients/',
                                    method='GET',
    ...
    def test_client_read(self):
        ...
        """
        response = self.client.open('/api/v1/clients/{client_id}/'.format(client_id='client_id_example'),
                                    method='GET')
        self.assert200(response, "Response body is : " + response.data.decode('utf-8'))
    ...
    def test_user_delete(self):
        ...
        """
        response = self.client.open('/api/v1/users/{user_id}/'.format(user_id='user_id_example'),
                                    method='DELETE')
        self.assert200(response, "Response body is : " + response.data.decode('utf-8'))
